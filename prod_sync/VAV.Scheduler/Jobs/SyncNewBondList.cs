...
{
    public class SyncNewBondList : VavJobObject
    {
        ...
        protected override void ExecuteInternal(JobExecutionContext context)
        {
            ...
            var lastSyncTime = new DateTime(1999, 12, 4);
            ...
            using (var vavEntities = new VAVEntities())
            {
                ...
                if (date != null)
                    lastSyncTime = date.Value.AddHours(-1);
            }
