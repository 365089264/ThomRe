...
{
    public class GeniusSyncJob : VavJobObject
    {
        ...
        protected override void ExecuteInternal(JobExecutionContext context)
        {
            ...
            try
            {
                using (var dataSync = new DataSynchronizer(settingManager, lastSyncTime, currentSyncTime))
                {
                    ...
                    //strInfo.Append(dataSync.Sync(sourceTable,16000));
                    strInfo.Append(dataSync.SyncEachTableFromMaxMtime(sourceTable));
                }
