...
namespace Luna.DataSync.Setting
{
	public class TableMapping
	{
        ...
        private bool _isContainFilePath;
        public bool IsContainFilePath
        {
            get { return _isContainFilePath; }
            set { _isContainFilePath = value; }
        }
	    ...
	    public bool IsCheckFileSynced { get; set; }
